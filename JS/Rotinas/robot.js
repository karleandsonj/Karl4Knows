            ...
            for (let i = 2; i < maxRows; i++) {
                ...
                if (columns[0].textContent.trim() !== '') {
                    ...
                    viewButton.addEventListener('click', () => {
                        ...
                        EditForm.innerHTML = `
                                <input type="hidden" id="uniqueID_robot_Edit" name="uniqueID" style="display: none;">
                                <input type="hidden" id="sistema_robot_EDIT" name="sistema" style="display: none;">
                                <input type="hidden" id="img_robot_EDIT" name="imageUrl" style="display: none;">
                                <input type="hidden" id="nomearq_robot_EDIT" name="descricao_anexo" style="display: none;">
                                <input type="hidden" id="arq_robot_EDIT" name="anexoUrl" style="display: none;">
                                ...
                                <div class="ErroSolucaoFORM-EDIT" id="ErroSolucaoFORM-EDIT">
                                    <div class="modal1-edit" id="modal1-edit">
                                        <h3>Erro Resumido: </h3>
                                        <input type="text" id="P_robot0_edit" name="erro_resumido" placeholder="Erro Resumido" class="campo0-edit" autocomplete="off">
                                    </div>
                                    <div class="modal2-edit" id="modal2-edit">
                                        <h3>Erro Detalhado: </h3>
                                        <textarea type="text" id="P_robot_edit" name="erro" placeholder="Erros" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                    <div class="modal3-edit">
                                        <h3>Soluções: </h3>
                                        <textarea type="text" id="P_robot1_edit" name="solucao" placeholder="Soluções" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                                <div class="AnexoScriptFORM-EDIT" id="AnexoScriptFORM-EDIT" style="display: none;">
                                    <div class="modal4-edit">
                                        <h3>Scripts:</h3>
                                        <textarea type="text" id="P_robot2_edit" name="script" placeholder="Script" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                        ...
                        submitButton.addEventListener('click', e => {
                            const textareaedit1 = document.getElementById('P_robot_edit');
                            const textareaedit2 = document.getElementById('P_robot1_edit');
                        ...
                        function sendFormEdit() {
                            ...
                            const uniqueIDEdit = document.getElementById('uniqueID_robot_Edit').value;
                        ...
                        const uniqueID_robot_Edit = document.getElementById("uniqueID_robot_Edit");
                        const sistema_robot_edit = document.getElementById("sistema_robot_EDIT");
                        ...
                        const img_robot_EDIT = document.getElementById("img_robot_EDIT");
                        const nomearq_robot_EDIT = document.getElementById("nomearq_robot_EDIT");
                        const arq_robot_EDIT = document.getElementById("arq_robot_EDIT");

                        img_robot_EDIT.value = imagemLink;
                        nomearq_robot_EDIT.value = descricao_anexo;
                        arq_robot_EDIT.value = anexo;
                        P_robot0_edit.value = errorsressumorobotData;
                        P_robot_edit.value = erros;
                        P_robot1_edit.value = solucoes;
                        P_robot2_edit.value = script;
                        sistema_robot_edit.value = sistema;
                        uniqueID_robot_Edit.value = uniqueID;
