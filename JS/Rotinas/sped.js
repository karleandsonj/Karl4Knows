                ...
                if (columns[0].textContent.trim() !== '') {
                    ...
                    viewButton.addEventListener('click', () => {
                        ...
                        /*                         // Selecionando os inputs pelos IDs
                                                const errosInput = document.getElementById('P_sped-edit');
                                                const solucoesInput = document.getElementById('P_sped1-edit');
                                                const scriptInput = document.getElementById('P_sped2-edit');
                        ...
                        modalContent.innerHTML = `
                            <div class="modal1">
                                <h3>${sistema}</h3>
                                <a id="EDITFORMSHEET-sped" title="Editar!"><img src="IMG/EDIT.png" class="EDIT-FORM-SHEET"></a>
                            </div>
                            <div id="column">
                        ...
                        EditForm.innerHTML = `
                                <input type="hidden" id="uniqueID_sped_Edit" name="uniqueID" style="display: none;">
                                <input type="hidden" id="sistema_sped_EDIT" name="sistema" style="display: none;">
                                <input type="hidden" id="img_sped_EDIT" name="imageUrl" style="display: none;">
                                <input type="hidden" id="nomearq_sped_EDIT" name="descricao_anexo" style="display: none;">
                                <input type="hidden" id="arq_sped_EDIT" name="anexoUrl" style="display: none;">
                                ...
                                <div class="ErroSolucaoFORM-EDIT" id="ErroSolucaoFORM-EDIT">
                                    <div class="modal1-edit" id="modal1-edit">
                                        <h3>Erro Resumido: </h3>
                                        <input type="text" id="P_sped0_edit" name="erro_resumido" placeholder="Erro Resumido" class="campo0-edit" autocomplete="off">
                                    </div>
                                    <div class="modal2-edit" id="modal2-edit">
                                        <h3>Erro Detalhado: </h3>
                                        <textarea type="text" id="P_sped_edit" name="erro" placeholder="Erros" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                    <div class="modal3-edit">
                                        <h3>Soluções: </h3>
                                        <textarea type="text" id="P_sped1_edit" name="solucao" placeholder="Soluções" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                                <div class="AnexoScriptFORM-EDIT" id="AnexoScriptFORM-EDIT" style="display: none;">
                                    <div class="modal4-edit">
                                        <h3>Scripts:</h3>
                                        <textarea type="text" id="P_sped2_edit" name="script" placeholder="Script" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                        ...
                        submitButton.addEventListener('click', e => {
                            const textareaedit1 = document.getElementById('P_sped_edit');
                            const textareaedit2 = document.getElementById('P_sped1_edit');
                        ...
                        function sendFormEdit() {
                            ...
                            const uniqueIDEdit = document.getElementById('uniqueID_sped_Edit').value;
                        ...
                        const uniqueID_sped_Edit = document.getElementById("uniqueID_sped_Edit");
                        const sistema_sped_edit = document.getElementById("sistema_sped_EDIT");
                        ...
                        const P_sped2_edit = document.getElementById("P_sped2_edit");
                        const img_sped_EDIT = document.getElementById("img_sped_EDIT");
                        const nomearq_sped_EDIT = document.getElementById("nomearq_sped_EDIT");
                        const arq_sped_EDIT = document.getElementById("arq_sped_EDIT");

                        img_sped_EDIT.value = imagemLink;
                        nomearq_sped_EDIT.value = descricao_anexo;
                        arq_sped_EDIT.value = anexo;
                        P_sped0_edit.value = errorsressumospedData;
                        P_sped_edit.value = erros;
                        P_sped1_edit.value = solucoes;
                        P_sped2_edit.value = script;
                        sistema_sped_edit.value = sistema;
                        uniqueID_sped_Edit.value = uniqueID;
                        ...
                        formatarTextoComQuebrasDeLinhaEDIT('P_sped_edit');
                        formatarTextoComQuebrasDeLinhaEDIT('P_sped1_edit');
                        formatarTextoComQuebrasDeLinhaEDIT2('P_sped2_edit');
                        formatarTextoComQuebrasDeLinhaEDIT2('P_sped3_edit');
                        formatarTextoComQuebrasDeLinhaEDIT2('P_sped4_edit');
                        formatarTextoComQuebrasDeLinhaEDIT2('P_sped5_edit');
                    });
