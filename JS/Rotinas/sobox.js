            ...
            for (let i = 3; i < maxRows; i++) {
                ...
                if (columns[0].textContent.trim() !== '') {
                    ...
                    viewButton.addEventListener('click', () => {
                        ...
                        EditForm.innerHTML = `
                                <input type="hidden" id="uniqueID_sobox_Edit" name="uniqueID" style="display: none;">
                                <input type="hidden" id="sistema_sobox_EDIT" name="sistema" style="display: none;">
                                <input type="hidden" id="img_sobox_EDIT" name="imageUrl" style="display: none;">
                                <input type="hidden" id="nomearq_sobox_EDIT" name="descricao_anexo" style="display: none;">
                                <input type="hidden" id="arq_sobox_EDIT" name="anexoUrl" style="display: none;">
                                ...
                                <div class="ErroSolucaoFORM-EDIT" id="ErroSolucaoFORM-EDIT">
                                    <div class="modal1-edit" id="modal1-edit">
                                        <h3>Erro Resumido: </h3>
                                        <input type="text" id="P_sobox0_edit" name="erro_resumido" placeholder="Erro Resumido" class="campo0-edit" autocomplete="off">
                                    </div>
                                    <div class="modal2-edit" id="modal2-edit">
                                        <h3>Erro Detalhado: </h3>
                                        <textarea type="text" id="P_sobox_edit" name="erro" placeholder="Erros" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                    <div class="modal3-edit">
                                        <h3>Soluções: </h3>
                                        <textarea type="text" id="P_sobox1_edit" name="solucao" placeholder="Soluções" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                                <div class="AnexoScriptFORM-EDIT" id="AnexoScriptFORM-EDIT" style="display: none;">
                                    <div class="modal4-edit">
                                        <h3>Scripts:</h3>
                                        <textarea type="text" id="P_sobox2_edit" name="script" placeholder="Script" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                        ...
                        submitButton.addEventListener('click', e => {
                            const textareaedit1 = document.getElementById('P_sobox_edit');
                            const textareaedit2 = document.getElementById('P_sobox1_edit');
                        ...
                        function sendFormEdit() {
                            ...
                            const uniqueIDEdit = document.getElementById('uniqueID_sobox_Edit').value;
                        ...
                        const uniqueID_sobox_Edit = document.getElementById("uniqueID_sobox_Edit");
                        const sistema_sobox_edit = document.getElementById("sistema_sobox_EDIT");
                        ...
                        const img_sobox_EDIT = document.getElementById("img_sobox_EDIT");
                        const nomearq_sobox_EDIT = document.getElementById("nomearq_sobox_EDIT");
                        const arq_sobox_EDIT = document.getElementById("arq_sobox_EDIT");

                        img_sobox_EDIT.value = imagemLink;
                        nomearq_sobox_EDIT.value = descricao_anexo;
                        arq_sobox_EDIT.value = anexo;
                        P_sobox0_edit.value = errorsressumosoboxData;
                        P_sobox_edit.value = erros;
                        P_sobox1_edit.value = solucoes;
                        P_sobox2_edit.value = script;
                        sistema_sobox_edit.value = sistema;
                        uniqueID_sobox_Edit.value = uniqueID;
