...
const sgaboxnewsheetURL = `https://docs.google.com/spreadsheets/d/1Jovno7NeDFhTmj0_97pbIeVYEZuxTh0qqs9JKP1lnhA/edit?usp=drive_link`;
        ...
        .then(data => {
            ...
            for (let i = 3; i < maxRows; i++) {
                ...
                if (columns[0].textContent.trim() !== '') {
                    ...
                    const errorsressumosgaboxnewData = columns[2].textContent.trim();
                    ...
                    viewButton.addEventListener('click', () => {
                        ...
                        modalContent.innerHTML = `
                            ...
                            <div id="column">
                                <div class="modal4" style="${script ? '' : 'display: none;'}">
                                    <h3>Scripts:</h3>
                                    <a href="#" title="Copiar!" id="copyLink" onclick="copyToClipboardscriptsgaboxnew()" >📄</a>
                                    <hr class="hr-rot">
                        ...
                        EditForm.innerHTML = `
                                <input type="hidden" id="uniqueID_sgaboxnew_Edit" name="uniqueID" style="display: none;">
                                <input type="hidden" id="sistema_sgaboxnew_EDIT" name="sistema" style="display: none;">
                                <input type="hidden" id="img_sgaboxnew_EDIT" name="imageUrl" style="display: none;">
                                <input type="hidden" id="nomearq_sgaboxnew_EDIT" name="descricao_anexo" style="display: none;">
                                <input type="hidden" id="arq_sgaboxnew_EDIT" name="anexoUrl" style="display: none;">
                                ...
                                <div class="ErroSolucaoFORM-EDIT" id="ErroSolucaoFORM-EDIT">
                                    <div class="modal1-edit" id="modal1-edit">
                                        <h3>Erro Resumido: </h3>
                                        <input type="text" id="P_sgaboxnew0_edit" name="erro_resumido" placeholder="Erro Resumido" class="campo0-edit" autocomplete="off">
                                    </div>
                                    <div class="modal2-edit" id="modal2-edit">
                                        <h3>Erro Detalhado: </h3>
                                        <textarea type="text" id="P_sgaboxnew_edit" name="erro" placeholder="Erros" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                    <div class="modal3-edit">
                                        <h3>Soluções: </h3>
                                        <textarea type="text" id="P_sgaboxnew1_edit" name="solucao" placeholder="Soluções" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                                <div class="AnexoScriptFORM-EDIT" id="AnexoScriptFORM-EDIT" style="display: none;">
                                    <div class="modal4-edit">
                                        <h3>Scripts:</h3>
                                        <textarea type="text" id="P_sgaboxnew2_edit" name="script" placeholder="Script" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                        ...
                        submitButton.addEventListener('click', e => {
                            const textareaedit1 = document.getElementById('P_sgaboxnew_edit');
                            const textareaedit2 = document.getElementById('P_sgaboxnew1_edit');
                        ...
                        function sendFormEdit() {
                            ...
                            const uniqueIDEdit = document.getElementById('uniqueID_sgaboxnew_Edit').value;
                        ...
                        const uniqueID_sgaboxnew_Edit = document.getElementById("uniqueID_sgaboxnew_Edit");
                        const sistema_sgaboxnew_edit = document.getElementById("sistema_sgaboxnew_EDIT");
                        ...
                        const img_sgaboxnew_EDIT = document.getElementById("img_sgaboxnew_EDIT");
                        const nomearq_sgaboxnew_EDIT = document.getElementById("nomearq_sgaboxnew_EDIT");
                        const arq_sgaboxnew_EDIT = document.getElementById("arq_sgaboxnew_EDIT");

                        img_sgaboxnew_EDIT.value = imagemLink;
                        nomearq_sgaboxnew_EDIT.value = descricao_anexo;
                        arq_sgaboxnew_EDIT.value = anexo;
                        ...
                        sistema_sgaboxnew_edit.value = sistema;
                        uniqueID_sgaboxnew_Edit.value = uniqueID;
...
/* Copiar Script-sgaboxnew*/
function copyToClipboardscriptsgaboxnew() {
    const infoText = document.getElementById("P_sgaboxnew2").innerText;
