...
const gourmetsheetURL = `https://docs.google.com/spreadsheets/d/1wxu6t8NxQI_w6zzhaw54Ir7SO-EQIYR9B_7BG6hdKFM/edit?usp=drive_link`;

// Função para carregar os dados da planilha na tabela com o id "data-table"
function loadgourmetSheetData(url) {
    fetch(url)
        ...
        .then(data => {
            ...
            const dataTableBody = document.querySelector('#data-table-gourmet tbody');
            ...
            for (let i = 2; i < maxRows; i++) {
                ...
                // Verificar se todas as colunas relevantes (ID_gourmet, ERROS, FOTOS, SOLUCOES) estão preenchidas
                if (columns[0].textContent.trim() !== '') {

                    const errorsressumogourmetCell = document.createElement('td');
                    const errorsressumogourmetData = columns[2].textContent.trim();
                    errorsressumogourmetCell.innerHTML = `<span>${errorsressumogourmetData}</span>`;

                    errorsressumogourmetCell.classList.add('erro1'); // Substitua 'sua-classe-aqui' pelo nome da classe desejada
                    ...
                    viewButton.addEventListener('click', () => {
                        ...
                        /*                         // Selecionando os inputs pelos IDs
                                                const errosInput = document.getElementById('P_gourmet-edit');
                                                const solucoesInput = document.getElementById('P_gourmet1-edit');
                                                const scriptInput = document.getElementById('P_gourmet2-edit');
                        ...
                        const linksString = linksArray.map((link, index) => `
                            <a href="${link}" id="P_gourmet${index + 1}" target="_blank" class="buttonDownload">${descricaoAnexoArray[index]}</a>
                        `).join('');
                        ...
                        <div class="imagem-div" >
                            <img class="img_anexo imagem-div1" id="P_gourmet4${index + 1}" src="${link}" alt="">
                        </div>
                        `).join('');
                        ...
                        modalContent.innerHTML = `
                            <div class="modal1">
                                <h3>${sistema}</h3>
                                <a id="EDITFORMSHEET-gourmet" title="Editar!"><img src="IMG/EDIT.png" class="EDIT-FORM-SHEET"></a>
                            </div>
                            <div id="column">
                                <div class="modal2" id="modal2" class="scroll-modal">
                                    <h3>Erro Detalhado: </h3>
                                    <hr class="hr-rot">
                                    <p id="P_gourmet">${erros}</p>
                                </div>
                                <div class="modal3" class="scroll-modal">
                                    <h3>Soluções: </h3>
                                    <hr class="hr-rot">
                                    <p id="P_gourmet1">${solucoes}</p>
                                </div>
                            </div>
                            <div id="column">
                                <div class="modal4" style="${script ? '' : 'display: none;'}">
                                    <h3>Scripts:</h3>
                                    <a href="#" title="Copiar!" id="copyLink" onclick="copyToClipboardscriptgourmet()" >📄</a>
                                    <hr class="hr-rot">
                                    <p id="P_gourmet2" class="scroll-modal">${script}</p>
                                </div>
                        ...
                        const openEditFormButton = document.getElementById('EDITFORMSHEET-gourmet');
                        ...
                        EditForm.innerHTML = `
                                <input type="hidden" id="uniqueID_gourmet_Edit" name="uniqueID" style="display: none;">
                                <input type="hidden" id="sistema_gourmet_EDIT" name="sistema" style="display: none;">
                                <input type="hidden" id="img_gourmet_EDIT" name="imageUrl" style="display: none;">
                                <input type="hidden" id="nomearq_gourmet_EDIT" name="descricao_anexo" style="display: none;">
                                <input type="hidden" id="arq_gourmet_EDIT" name="anexoUrl" style="display: none;">
                                ...
                                <div class="ErroSolucaoFORM-EDIT" id="ErroSolucaoFORM-EDIT">
                                    <div class="modal1-edit" id="modal1-edit">
                                        <h3>Erro Resumido: </h3>
                                        <input type="text" id="P_gourmet0_edit" name="erro_resumido" placeholder="Erro Resumido" class="campo0-edit" autocomplete="off">
                                    </div>
                                    <div class="modal2-edit" id="modal2-edit">
                                        <h3>Erro Detalhado: </h3>
                                        <textarea type="text" id="P_gourmet_edit" name="erro" placeholder="Erros" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                    <div class="modal3-edit">
                                        <h3>Soluções: </h3>
                                        <textarea type="text" id="P_gourmet1_edit" name="solucao" placeholder="Soluções" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                                <div class="AnexoScriptFORM-EDIT" id="AnexoScriptFORM-EDIT" style="display: none;">
                                    <div class="modal4-edit">
                                        <h3>Scripts:</h3>
                                        <textarea type="text" id="P_gourmet2_edit" name="script" placeholder="Script" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                        ...
                        submitButton.addEventListener('click', e => {
                            const textareaedit1 = document.getElementById('P_gourmet_edit');
                            const textareaedit2 = document.getElementById('P_gourmet1_edit');
                        ...
                        function sendFormEdit() {
                            ...
                            const uniqueIDEdit = document.getElementById('uniqueID_gourmet_Edit').value;
                        ...
                        const uniqueID_gourmet_Edit = document.getElementById("uniqueID_gourmet_Edit");
                        const sistema_gourmet_edit = document.getElementById("sistema_gourmet_EDIT");
                        const P_gourmet0_edit = document.getElementById("P_gourmet0_edit");
                        const P_gourmet_edit = document.getElementById("P_gourmet_edit");
                        const P_gourmet1_edit = document.getElementById("P_gourmet1_edit");
                        const P_gourmet2_edit = document.getElementById("P_gourmet2_edit");
                        const img_gourmet_EDIT = document.getElementById("img_gourmet_EDIT");
                        const nomearq_gourmet_EDIT = document.getElementById("nomearq_gourmet_EDIT");
                        const arq_gourmet_EDIT = document.getElementById("arq_gourmet_EDIT");

                        img_gourmet_EDIT.value = imagemLink;
                        nomearq_gourmet_EDIT.value = descricao_anexo;
                        arq_gourmet_EDIT.value = anexo;
                        P_gourmet0_edit.value = errorsressumogourmetData;
                        P_gourmet_edit.value = erros;
                        P_gourmet1_edit.value = solucoes;
                        P_gourmet2_edit.value = script;
                        sistema_gourmet_edit.value = sistema;
                        uniqueID_gourmet_Edit.value = uniqueID;
                        ...
                        transformarEmListaOrdenada('P_gourmet'); // Substituir 'P_gourmet1' pelo ID desejado
                        transformarEmListaOrdenada('P_gourmet1'); // Substituir 'P_gourmet2' pelo ID desejado                        
                        ...
                        formatarTextoComQuebrasDeLinha('P_gourmet');
                        formatarTextoComQuebrasDeLinha('P_gourmet1');
                        formatarTextoComQuebrasDeLinha2('P_gourmet2');
                        formatarTextoComQuebrasDeLinha2('P_gourmet3');
                        formatarTextoComQuebrasDeLinha2('P_gourmet4');
                        formatarTextoComQuebrasDeLinha2('P_gourmet5');

                        //quebrar linha do edit
                        formatarTextoComQuebrasDeLinhaEDIT('P_gourmet_edit');
                        formatarTextoComQuebrasDeLinhaEDIT('P_gourmet1_edit');
                        formatarTextoComQuebrasDeLinhaEDIT2('P_gourmet2_edit');
                        formatarTextoComQuebrasDeLinhaEDIT2('P_gourmet3_edit');
                        formatarTextoComQuebrasDeLinhaEDIT2('P_gourmet4_edit');
                        formatarTextoComQuebrasDeLinhaEDIT2('P_gourmet5_edit');
                    });

                    viewButtonCell.appendChild(viewButton); // Adicionar o botão à célula

                    const newRow = document.createElement('tr');
                    newRow.appendChild(errorsressumogourmetCell);
...
const closeModalgourmetButton = document.getElementById('closeModal');
const infoModalgourmet = document.getElementById('infoModal');

closeModalgourmetButton.addEventListener('click', () => {
    infoModalgourmet.style.display = 'none';
});


// Chamar a função para carregar os dados da planilha
loadgourmetSheetData(gourmetsheetURL);

/* FIM DADOS */

/* Copiar Script-gourmet*/
function copyToClipboardscriptgourmet() {
    const infoText = document.getElementById("P_gourmet2").innerText;
