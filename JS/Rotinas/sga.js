            ...
            for (let i = 3; i < maxRows; i++) {
                ...
                if (columns[0].textContent.trim() !== '') {
                    ...
                    viewButton.addEventListener('click', () => {
                        ...
                        EditForm.innerHTML = `
                                <input type="hidden" id="uniqueID_sga_Edit" name="uniqueID" style="display: none;">
                                <input type="hidden" id="sistema_sga_EDIT" name="sistema" style="display: none;">
                                <input type="hidden" id="img_sga_EDIT" name="imageUrl" style="display: none;">
                                <input type="hidden" id="nomearq_sga_EDIT" name="descricao_anexo" style="display: none;">
                                <input type="hidden" id="arq_sga_EDIT" name="anexoUrl" style="display: none;">
                                ...
                                <div class="ErroSolucaoFORM-EDIT" id="ErroSolucaoFORM-EDIT">
                                    <div class="modal1-edit" id="modal1-edit">
                                        <h3>Erro Resumido: </h3>
                                        <input type="text" id="P_sga0_edit" name="erro_resumido" placeholder="Erro Resumido" class="campo0-edit" autocomplete="off">
                                    </div>
                                    <div class="modal2-edit" id="modal2-edit">
                                        <h3>Erro Detalhado: </h3>
                                        <textarea type="text" id="P_sga_edit" name="erro" placeholder="Erros" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                    <div class="modal3-edit">
                                        <h3>Soluções: </h3>
                                        <textarea type="text" id="P_sga1_edit" name="solucao" placeholder="Soluções" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                                <div class="AnexoScriptFORM-EDIT" id="AnexoScriptFORM-EDIT" style="display: none;">
                                    <div class="modal4-edit">
                                        <h3>Scripts:</h3>
                                        <textarea type="text" id="P_sga2_edit" name="script" placeholder="Script" class="campo-edit" autocomplete="off"></textarea>
                                    </div>
                                </div>
                        ...
                        function sendFormEdit() {
                            ...
                            const uniqueIDEdit = document.getElementById('uniqueID_sga_Edit').value;
                        ...
                        const uniqueID_sga_Edit = document.getElementById("uniqueID_sga_Edit");
                        const sistema_sga_edit = document.getElementById("sistema_sga_EDIT");
                        ...
                        const img_sga_EDIT = document.getElementById("img_sga_EDIT");
                        const nomearq_sga_EDIT = document.getElementById("nomearq_sga_EDIT");
                        const arq_sga_EDIT = document.getElementById("arq_sga_EDIT");

                        img_sga_EDIT.value = imagemLink;
                        nomearq_sga_EDIT.value = descricao_anexo;
                        arq_sga_EDIT.value = anexo;
                        P_sga0_edit.value = errorsressumosgaData;
                        P_sga_edit.value = erros;
                        P_sga1_edit.value = solucoes;
                        P_sga2_edit.value = script;
                        sistema_sga_edit.value = sistema;
                        uniqueID_sga_Edit.value = uniqueID;
